...
<?php $base_url = base_url('control/users') ?>
	...
	<table class="ui basic celled unstackable table">
		<thead>
			<tr>
				...
				<th><?= lang('ui_posts_created') ?> <a href="<?= "$filters_base_url/posts_count/order/$order" ?>"><i class="sort icon mr-0"></i></a></th>
		...
		<tbody>
			...
			<tr>
				...
				<td class="center aligned"><?= $user->user_posts_count ?></td>
...
<script>var users = 'administrators'</script>
