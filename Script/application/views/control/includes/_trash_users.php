...
<?php $base_url = base_url('control/trash/users') ?>
	...
	<table class="ui basic celled unstackable table">
		<thead>
			<tr>
				...
				<th><?= lang('ui_created_at') ?> <a href="<?= "$filters_base_url/deleted_at/order/$order" ?>"><i class="sort icon mr-0"></i></a></th>
				<th><?= lang('ui_deleted_at') ?> <a href="<?= "$filters_base_url/created_at/order/$order" ?>"><i class="sort icon mr-0"></i></a></th>
			</tr>
		</thead>
		...
		<tbody>
			...
			<tr>
				...
				<td><?= ucfirst($user->user_email) ?></td>
				<td><?= $user->user_deleted_at ?></td>
